...
export default class RoleController extends Controller {
    ...
    async index() {
        ...
        await service.authAuthInRole.check('role', 'list', ctx.request.headers.authorization, device, lang);
    ...
    async create() {
        ...
        await service.authAuthInRole.check('role', 'add', ctx.request.headers.authorization, device, lang);
    ...
    async update() {
        ...
        await service.authAuthInRole.check('role', 'edit', ctx.request.headers.authorization, device, lang);
    ...
    async destroy() {
        ...
        await service.authAuthInRole.check('role', 'delete', ctx.request.headers.authorization, device, lang);
